<template>
  <form class="meetup-form" @submit.prevent="submitMeetup">
  ...
  methods: {
    ...
    addAgendaItem() {
      ...
      if (lengthAgenda) {
        ...
        newAgendaItem.startsAt = this.localMeetup.agenda[lengthAgenda - 1].endsAt;
